 ...
 * @version 1.0
 */
package com.droplink.keycloak.utils;
...
public final class OTPUtils {
  ...
  public static final boolean isOTPExprired(long otpTimestamp, long ttl) {
    long currentTime = System.currentTimeMillis();
    return (currentTime - otpTimestamp) > (ttl * 1000);
  }

  public static final boolean isOTPExprired(String otpTimestamp, long ttl) {
